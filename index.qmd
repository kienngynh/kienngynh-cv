...
A passionate Engineer with experience in embedded systems, IoT, and automation. Possesses strong programming skills in Rust, Python, C#, C++, and PLC languages. Eager to contribute to innovative projects and leverage blockchain technology to solve real-world challenges.

# Skills

## Embedded Systems

* Experience in designing, developing, and debugging firmware for microcontrollers and microprocessors.
* Extensive experience with communication protocols including I2C, SPI, UART, Modbus, BACnet and Ethernet.
* Knowledgeable in power management, signal processing, and sensor interfacing.
* Skilled in embedded Linux development, including kernel customization, driver development, and user-space applications.

## Blockchain

* Experience with popular blockchain platforms Polkadot.
...
* IDEs: Neovim 
* Documentation Tools: Quarto, Mermaid Chart
